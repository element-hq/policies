# {{ homeserver }} Homeserver Privacy Notice
...
The {{ homeserver }} homeserver is a *decentralised* and *open* service. This means that, to support communication between users on different homeservers or different messaging platforms, your username, display name and messages and files are sometimes shared with other services that are connected with the {{ homeserver }} homeserver.
